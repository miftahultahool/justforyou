...
const second = 1000,
  ...
  hour = minute * 60,
  day = hour * 24;
let countDown = new Date('Apr 06, 2021 00:00:00').getTime(),
...
new TypeIt("#teks1", {
  strings: ["Hai Rangga!", " ", "<b>Selamat Ulang Tahun Yang ke-19 ya Sayang</b>", " ", "Semoga diberi kesehatan, tercapai cita-citanya, jadi anak yang berbakti kepada orang tua, dan bahagia selalu. Aamiin.", " " , " I Love You today, tomorrow, and forever.", " " ,"with love,", "", "-Mifta, your gf."],
  startDelay: 4000,
  speed: 75,
...
new TypeIt("#teks2", {
  strings: ["Asik ditunggu traktirannyooo yantokkk","", "Happy Birthday lagiiiii nah ","", "Lah tuo berentila gawe lolo ehhh wkkw", " " ,
  "Sudah 19 tahun, kurangilah maen HP tuhh rajenlaa belajar ujinyo nak jadi tentaro.","", "Maapp ehh aku dak biso ngasih yg mahal atau romantis cak yg lain dan ini malah terkesan alay. Cuma ini yang biso aku kasih ke kau maap men sederhana hm, tapi semoga kau senyum senyum dibuatnyo heheh aku sayang kauuuuuuu :)", " " , "Sekali lagi, Selamat Ulang Tahun yoooooo. Semoga segaloo impian, keinginan, dan harapan kau biso tercapai, Aamiin."],
  startDelay: 2000,
  speed: 75,
  waitUntilVisible: true
}).go();
